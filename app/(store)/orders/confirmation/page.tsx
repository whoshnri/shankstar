...
export default async function ConfirmationPage({
  ...
  if (!orderNumber || !order) {
    return (
      <div className="py-20 px-4 md:px-6 flex items-center justify-center min-h-[50vh]">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          <div className="mb-6 flex justify-center">
            <div className="w-16 h-16 bg-green-50 text-gray-400 rounded-full flex items-center justify-center">
              <CheckCircle size={32} />
            </div>
          </div>
